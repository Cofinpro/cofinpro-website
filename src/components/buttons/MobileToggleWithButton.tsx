...
class MobileToggleWithButton extends React.Component<Props> {
  render() {
    const { dataTargetId, show, styleClasses } = this.props;

    return (
      <div className={`d-block d-md-none col-12 col-md-4 order-1 order-md-2 text-center margin-10-bottom ${styleClasses}`}>
        <div
          style={{
