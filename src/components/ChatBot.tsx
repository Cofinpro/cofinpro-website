...
class ChatBot extends React.Component {
    ...
    this.state = {
      messageList: [
        ...
        },
        {
          ...
          author: 'them',
          data: {
            text: 'Du willst mehr über unsere Beratung und den Bewerbungsprozess erfahren? Dann schieß einfach los.',
          },
        },
      ],
      newMessagesCount: 0,
  ...
  render() {
    ...
    let urlFragmentPers = pathPrefix != null && pathPrefix.length > 2 ? 1 : 0;

    let mainUrl = pathPrefix != null && pathPrefix.length > 2 ? pathPrefix : '/karriere';

    return (
      <div hidden={locationUpdate === mainUrl || locationUpdate.startsWith('/karriere') !== 0 ? true : false}>
        <Launcher
          agentProfile={{
