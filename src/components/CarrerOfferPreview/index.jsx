...
class CarrerOfferPreview extends React.Component {
    render() {
        const { title, employmentType, expiration, locationEmployee, anzeigeId, location, styleClass } = this.props
        ...
        return (
            <div className={"carrerOfferPreview " + additionalStyleClass}>
                ...
                <Link to={pathPrefix + "/stellenanzeige/" + anzeigeId} className="text-dark">
