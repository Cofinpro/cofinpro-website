...
class FokusthemenLayout extends React.Component<Props> {
  private readonly colorSchema = [
    '--blue-yellow',
    '--grey-orange',
    '--orange-pink',
    '--grey-blue',
  ...
  render() {
    ...
    const indexOfFokusthemaWithText = fokusthemen.length > 2 ? 2 : fokusthemen.length - 1;
    ...
    let styleRowFokusthema8 =
      fokusthemen.length < 10 ? 'margin-40-top margin-md-20-top align-items-start' : 'margin-40-top margin-md-20-top align-items-center';
    let styleColFokusthema8 = fokusthemen.length < 10 ? 'margin-120-top margin-md-60-top' : '';

    styleRowFokusthema8 = fokusthemen.length < 9 ? '' : styleRowFokusthema8;
    styleColFokusthema8 = fokusthemen.length < 9 ? '' : styleColFokusthema8;

    const styleClassContainer4till6 = fokusthemen.length < 6 ? 'align-items-start margin-40-top' : 'align-items-end negative-margin-80-top';
    const styleColFokusthema3 = fokusthemen.length < 6 ? 'negative-margin-100-top' : '';
        ...
        <div className={'container ' + style.container}>
          ...
          {fokusthemen.length > 3 && (
            <div className="row d-flex d-md-none">
              ...
              <div className="col-12">
                <MobileToggleWithButton show={true} dataTargetId={'collapse-more-fokusthemen'} styleClasses={'margin-20-top'} />
              </div>
            </div>
          )}
            ...
            <div className="row d-none d-md-flex align-items-center margin-40-top margin-md-20-top">
              ...
              <div className="col-4">
                <p className="h4 text-md-normal margin-40-top margin-md-0-top">
                  Mit Teams aus Management-, Fach- und Technologieberatern unterstützen wir Banken und Kapitalverwaltungsgesellschaften,
                  damit sie den unterschiedlichsten Herausforderungen gerecht werden.
                </p>
              </div>
            </div>
          )}
          ...
          {showButton && (
            <div className="row margin-40-top margin-xs-20-top">
              <div className="col-12 col-md-4 order-2 order-md-1">
                <LinkButton styleSpan="w-100 w-md-unset" text="ZUR FOKUSTHEMEN-ÜBERSICHT" path="/fokusthemen/managementberatung" />
              </div>
            </div>
          )}
        </div>
