...
class FokusThemenFachLayout extends React.Component<Props> {
  render() {
    const { text, fokusthemen, style } = this.props;

    const containerStyle = style !== undefined && style.container !== undefined ? style.container : '';
    const textColStyle = style !== undefined && style.textCol !== undefined ? style.textCol : '';
