...
class MainNavigation extends React.Component<Props> {
  ...
  render() {
    ...
    return (
      <div className="main-navigation fixed-top" hidden={location.pathname.startsWith('/karriere')}>
              ...
              <div className="row">
                <div className="col">
                  <nav className="cofinpro-nav navbar navbar-expand-xl">
                    <Menu id="desktop-main-menu" location={location} locationUpdate={locationUpdate} {...this.props} />
                  </nav>
                </div>
              </div>
            </div>
        ...
        <div className="d-block d-xl-none">
          <Menu id="mobile-main-menu" location={location} locationUpdate={locationUpdate} {...this.props} />
        </div>
      </div>
    );
  }
