            ...
            <div className="col-12 col-md-8 col-lg-7">
              <div className="row d-flex d-md-none">
                <div className="col-3 col-lg-2">
                  <ImageWrapper sourceType={SourceTyp.Bootstrap} source={'/img/beratungsfelder/technologie/Technologie-Icon.png'} />
                </div>
              </div>
              <div className="row">
                <div className="col-12">
                  <h1 className="h1 margin-xs-20-top">Unsere Technologieberatung</h1>
          ...
          <div className="row margin-120-top margin-xs-40-top justify-content-center">
            <div className="col-md-10">
              <h3 className="h2 text-primary text-center">
                Wir betrachten die Plattformen <br />
                unserer Kunden ganzheitlich
              </h3>
              <ImageWrapper sourceType={SourceTyp.Sharp} source={this.props.data.headlineImageSharp} styleClasses={'margin-30-top'} />
            </div>
          </div>
        </div>
        <div className="container">
          ...
          <div className="row margin justify-content-center">
            <div className="col-md-6">
              <p>Auf diese Plattformen für unterschiedliche Zielgruppen fokussieren wir uns:</p>
              <ul className="blue-bullet">
                <li>
                  <b>Customer Experience: </b>
                  Diese Plattform stellt den B2C-Kunden in den Mittelpunkt. Eine hohe User Experience ermöglicht den digitalen Vertrieb
                  (komplexer) Finanzprodukte. Die Analyse des Kundenverhaltens hilft, ihn lückenlos zu verstehen. Durch die flexible
                  Anpassbarkeit können Änderungen im Markt bzw. geändertes Kundenverhalten schnell abgebildet werden.
                </li>
                <li>
                  <b>Ecosystems: </b> Regulatorik (PSD2) beschleunigt Marktveränderungen, der Trend zur stärkeren Spezialisierung der Banken
                  wird gefördert. Hier kommt Unbundling Banks ins Spiel. Banken entscheiden für jedes ihrer Produkte, ob sie es selbst
                  herstellen, von anderen einkaufen oder anderen anbieten. Damit steigen die Anforderungen an die Interoperabilität von
                  IT-Systemen. Mit dieser Plattform setzen wir auf die Bereitstellung und Verwaltung von APIs, die Modularisierung der
                  Systemlandschaft und auf die Anbindung von Legacy-Systemen zur Abbildung fachlicher Services.
                </li>
                <li>
                  <b>Information Systems: </b>
                  Diese Plattform automatisiert fachliche Prozesse im Unternehmen Ende-zu-Ende und macht sie so effizienter.
                </li>
              </ul>
            </div>
            <div className="col-md-6">
              <p>
                Um diese Plattformen zu entwickeln, bauen wir ein starkes Fundament. Dafür verwenden wir die aktuellste
                Entwicklungs-Infrastruktur, die unter anderem beinhaltet:
              </p>
              <ul className="blue-bullet">
                <li>moderne Methoden im Software Engineering wie DevOps und Scrum</li>
                <li>Continuous Delivery zur automatisierten und schnellen Bereitstellung von Software in kurzen Zyklen</li>
                <li>Toolchains zur Steigerung von Effizienz und Qualität innerhalb der Software-Entwicklung</li>
              </ul>
            </div>
          </div>
          <div className="row margin-120-top margin-xs-40-top">
            <div className="col-md-6">
              <h3 className="h3">Unsere Projektleistungen in der Technologieberatung in Kürze</h3>
              ...
              <ul className="blue-bullet margin-40-top margin-xs-20-top">
                <li>
                  <b>
                    <Link to={'/fokusthemen/thema/assessment-und-roadmap'}>Assessment und Roadmap:</Link>
                  </b>{' '}
                  Wir nehmen die Anforderungen an die IT unserer Kunden individuell auf, analysieren die aktuelle IT-Landschaft und
                  erarbeiten zusammen eine Roadmap zur Weiterentwicklung.
                </li>
                <li>
                  <b>
                    <Link to={'/fokusthemen/thema/modernisierung-von-it-architekturen'}>Modernize:</Link>
                  </b>{' '}
                  Wir analysieren vorhandene Anwendungen und Architekturen technisch, erarbeiten Ansätze zur Modernisierung und bewerten sie
                  im engen Austausch. Beim Konzeptionieren der IT-Architektur machen wir nicht halt, sondern setzen neue Lösungen auch um.
                </li>
                <li>
                  <b>
                    <Link to={'/fokusthemen/thema/aufbau-neuer-plattformen'}>Create:</Link>
                  </b>{' '}
                  Wir kümmern uns um den Aufbau neuer Plattformen für effizientere Prozessketten. Und wir schaffen modulare Architekturen
                  für Kooperationspartner und B2B-Kunden sowie Lösungen für digitale Geschäftsmodelle.
                </li>
              </ul>
            </div>
          </div>
