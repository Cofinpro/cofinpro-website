          ...
          <div className="container margin-120-top margin-xs-80-top">
            <div className="row">
              ...
              <div className="col-12 col-md-6 order-1 order-md-2">
                ...
                <p>
                  Wir wünschen uns langfristige, faire Geschäftsbeziehungen, mit denen sich nachhaltige Ergebnisse für unsere Kunden
                  erreichen lassen. Unser bedeutendstes Kapital dabei sind unsere Mitarbeiter, denn mit all ihrer professionellen und
                  menschlichen Unterschiedlichkeit sind sie das Herz von Cofinpro.
                </p>
                ...
                <p>
                  ...
                  unterzeichnet. Damit gehören wir zum größten deutschen Netzwerk für Diversity Management. Als Mitglied der Initiative
                  »Fair Company« hält sich Cofinpro an die ethischen Grundregeln der Arbeitswelt. Wir lehnen die Ausbeutung von
                  Berufseinsteigern ab, genauso wie jede Form von Korruption. Seit unserer Gründung wurden wir übrigens immer wieder als
            ...
            <div className="row">
              <div className="col-12 col-md-6">
                ...
                <p>
                  ...
                  Engagement für große und kleine Organisationen, Hilfswerke und Initiativen schon einiges mitbewegt zu haben. Dafür, und
                  für unsere täglich gelebten Werte als Arbeitgeber, wurden wir wiederholt ausgezeichnet.
                </p>
              </div>
            </div>
