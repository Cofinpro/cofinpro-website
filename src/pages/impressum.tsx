        ...
        <div className="min-view-height">
          <Helmet
            ...
            meta={[
              {
                name: 'Description',
                content: 'Impressum Cofinpro AG Untermainkai 27 - 28 60329 Frankfurt am Main Tel +49 (0) 69-2 99 20 87 60 Fax…',
              },
              {
                property: 'og:title',
          ...
          <div className="container padding-20-top padding-xs-20-top">
            <div className="row">
              <div className="col">
                ...
                <p>
                  <span className="bold-font">Vorsitzender des Aufsichtsrates</span>
                  <br />
                  Markus Bohner
                </p>
          ...
          <div className="container margin-20-top">
            <div className="row">
              <div className="col">
                <LinkButton text="Datenschutz" path="/datenschutz" styleSpan="margin-sm-right" />
