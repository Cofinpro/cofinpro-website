...
class PinnwandTemplate extends React.Component {
    ...
    render() {
        ...
        function OldNews(props) {
            ...
            return <div className="collapse" id="oldNewsContent">
                <div className="container">
                    <div className="row">

                        {props.allNews != null && props.allNews.length > 0 ? props.allNews.map((edge, i) => {
                            if (i >= threshold) {
                                return (
                                    <div className="col-12 col-md-6" key={"news-column-old-" + i}>
                                        <NewsPreview 
                                            key={"news-NewsPreview-old-" + i}
                                            createdAt={edge.node.datumFuerDieAnzeige}
                                            title={edge.node.ueberschrift}
                                            description={edge.node.kurzeBeschreibung.kurzeBeschreibung}
                                            newsId={edge.node.id}
        ...
        return (
            <div>
                    ...
                    meta={[
                        {
                            ...
                            content: "Hier findest Du Neues aus unserem Consulting, Fachartikel unserer Experten und alles, was wir unbedingt mit Dir teilen wollen."
                        }, {
                ...
                <div className="container padding-md-top">
                    ...
                    <div className="row">
                        <div className="col-12">
                            <h1 className="margin-md-top-bottom display-4 font-weight-bold">Pinnwand</h1>
                        </div>
                    </div>

                    <div className="row">

                        {allNews != null && allNews.length > 0 ? allNews.map((edge, i) => {
                            if (i < threshold) {
                                return (
                ...
                <OldNews oldNewsExists={oldNewsExists} allNews={allNews} {...this.props} />

                <div className={"container " + (allNews.length <= threshold ? "invisible" : "")}>
                    <div className="row margin-md-top-bottom">
                        <div className="col-12 text-center">
                            <button id="button-pinnwand-collapse" className="btn btn-light text-white" type="button" data-toggle="collapse" data-target="#oldNewsContent" aria-controls="navbarToggleExternalContent" aria-expanded="false" aria-label="Toggle navigation">
