              ...
              <div className="col-12 col-md-5">
                ...
                {graphQlResult.artenVonStudenten == null || graphQlResult.artenVonStudenten.length === 0 ?
                  <ContentBoxStyleOne
                    ...
                    paragraphs={[
                      graphQlResult.infoboxLinksObenBeschreibung.infoboxLinksObenBeschreibung,
                      graphQlResult.infoboxLinksObenBeschreibungAbsatz2.infoboxLinksObenBeschreibungAbsatz2
                    ]} />
                  : null
                }
              ...
              <div className="col-12 col-md-5 padding-lg-top">
                ...
                {graphQlResult.artenVonStudenten == null || graphQlResult.artenVonStudenten.length === 0 ?
                  <ContentBoxStyleOne
                    ...
                    paragraphs={[graphQlResult.infoboxRechtsObenBeschreibung.infoboxRechtsObenBeschreibung]} />
                  : null
                }
              ...
              <div className="col-12 col-md-5">
                ...
                {graphQlResult.artenVonStudenten == null || graphQlResult.artenVonStudenten.length === 0 ?
                  <ContentBoxStyleOne
                    ...
                    paragraphs={[graphQlResult.infoboxLinksUntenBeschreibung.infoboxLinksUntenBeschreibung]} />
                  : null
                }
          ...
          <div className="container padding-md-top-bottom">
            <div className="row">
              ...
              <div className="col-12 col-md-6">
                {
                  graphQlResult.artenVonStudenten.length > 0 ?
                    <div className="padding-md-top-bottom">
                      <p className="h4 padding-sm-bottom">{graphQlResult.artenVonStudenten[0].ueberschrift}</p>
              ...
              <div className="col-12 col-md-6">
              {
                  graphQlResult.artenVonStudenten.length > 1 ?
                    <div className="padding-md-top-bottom">
                      <p className="h4 padding-sm-bottom">{graphQlResult.artenVonStudenten[1].ueberschrift}</p>
                  ...
                  graphQlResult.artenVonStudenten.length > 2 ?
                    <div className="padding-md-top-bottom">
                      <p className="h4 padding-sm-bottom">{graphQlResult.artenVonStudenten[2].ueberschrift}</p>
            ...
            <div className="row">
              ...
              <div className="col-12 col-md-6">
              {
                  graphQlResult.artenVonStudenten.length > 2 ?
                    <div className="padding-md-top-bottom">
                      <p className="h4 padding-sm-bottom">{graphQlResult.artenVonStudenten[3].ueberschrift}</p>
              ...
              <div className="col-12 col-md-6">
              {
                  graphQlResult.artenVonStudenten.length > 2 ?
                    <div className="padding-md-top-bottom">
                      <p className="h4 padding-sm-bottom">{graphQlResult.artenVonStudenten[4].ueberschrift}</p>
            ...
            <div className="row">
              ...
              <div className="col-12 col-md-6">
              {
                  graphQlResult.artenVonStudenten.length > 2 ?
                    <div className="padding-md-top-bottom">
                      <p className="h4 padding-sm-bottom">{graphQlResult.artenVonStudenten[5].ueberschrift}</p>
