        ...
        <div className="container margin-60-top">
          <div className="row justify-content-center">
            <div className="col-12 col-md-8 text-center">
              <h2 className="h2 text-primary">Wir wünschen uns einfach Dich!</h2>
              <h1 className="h2">{graphQlResult.titel}</h1>
              <ContentfulMarkdownText styleClasses="margin-40-bottom" text={graphQlResult.absatzEins.absatzEins} />
            </div>
          </div>
        </div>
        ...
        <div className="container container-stellenanzeige-text">
          <div className="row">
            <div className="col-12 col-md-4">
              <h3 className="h4 margin-10-bottom">{graphQlResult.spaltenInfoTitelLinks}</h3>
              <ContentfulMarkdownText text={graphQlResult.spaltenInfoBeschreibungLinksLang.spaltenInfoBeschreibungLinksLang} />
              <div className="d-block d-md-none">
                <p className="margin-40-top" />
              </div>
            </div>
            <div className="col-12 col-md-4">
              <h3 className="h4 margin-10-bottom">{graphQlResult.spaltenInfoTitelMitte}</h3>
              <ContentfulMarkdownText text={graphQlResult.spaltenInfoBeschreibungMitte.spaltenInfoBeschreibungMitte} />
              <div className="d-block d-md-none">
                <p className="margin-40-top" />
              </div>
            </div>
            <div className="col-12 col-md-4">
              <h3 className="h4 margin-10-bottom">{graphQlResult.spaltenInfoTitelRechts}</h3>
              <ContentfulMarkdownText text={graphQlResult.spaltenInfoBeschreibungRechts.spaltenInfoBeschreibungRechts} />
            </div>
          </div>
        </div>
          ...
          <div className="row">
            <div className="col text-center">
              <div className="w-50 d-none d-lg-block mx-auto padding-sm-bottom stellenanzeige-call-to-action">
                ...
                <p className="p-small">
                  Bei Fragen zu deiner Bewerbung hat unser Recruitingteam (Tel. +49 (0) 69 / 2 99 20 87 60) ein offenes Ohr und unser
