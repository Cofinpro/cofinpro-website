...
class GehaltBeteiligungTemplate extends React.Component<Props> {
  render() {
    const graphQlResult = this.props.data.contentfulSeiteGehaltBenefits;

    // tslint:disable-next-line:function-name
    function CreateImage(props: any) {
      if (typeof props.image !== 'undefined') {
        return <ContentfulImage imageFile={props.image} styleClasses="img-fluid padding-md-bottom" />;
      }
    ...
    return (
      <div>
        ...
        <SiteHeaderContent
          ...
          text1={graphQlResult.absatz1Beschreibung ? graphQlResult.absatz1Beschreibung.absatz1Beschreibung : null}
          text2={graphQlResult.absatz2Beschreibung ? graphQlResult.absatz2Beschreibung.absatz2Beschreibung : null}
        />
        ...
        {graphQlResult.artenVonStudenten == null || graphQlResult.artenVonStudenten.length === 0 ? (
          <div className="container margin-120-top">
            <div className="row">
              <div className="col-12 col-md-5">
                <div className="row">
                  <div className="col-12 col-md-10 col-lg-9">
                    <h2 className="h6">{graphQlResult.infoboxLinksObenUntertitel}</h2>
                    <h3 className="h2">{graphQlResult.infoboxLinksObenTitel}</h3>
                    <CreateImage image={graphQlResult.infoboxLinksObenBild} {...this.props} />
                  </div>
                  <div className="col-12 col-md-2 col-lg-3" />
                  <div className="col-12 col-md-12">
                    <ContentfulMarkdownText text={graphQlResult.infoboxLinksObenBeschreibung.infoboxLinksObenBeschreibung} />
                    <ContentfulMarkdownText text={graphQlResult.infoboxLinksObenBeschreibungAbsatz2.infoboxLinksObenBeschreibungAbsatz2} />
                  </div>
                </div>
              </div>
              ...
              <div className="col-12 col-md-5">
                ...
                <div className="row">
                  <div className="col-12 col-md-10 col-lg-9">
                    <h2 className="h6">{graphQlResult.infoboxRechtsObenUntertitel}</h2>
                    <h3 className="h2">{graphQlResult.infoboxRechtsObenTitel}</h3>
                    <CreateImage image={graphQlResult.infoboxRechtsObenBild} {...this.props} />
                  </div>
                  <div className="col-12 col-md-2 col-lg-3" />
                  <div className="col-12 col-md-12">
                    <ContentfulMarkdownText text={graphQlResult.infoboxRechtsObenBeschreibung.infoboxRechtsObenBeschreibung} />
                  </div>
                </div>
              </div>
          ...
          <div className="container">
            <div className="row">
              ...
              <div className="col-12 col-md-5">
                ...
                <div className="row">
                  <div className="col-12 col-md-10 col-lg-9">
                    <h2 className="h6">{graphQlResult.infoboxLinksUntenUntertitel}</h2>
                    <h3 className="h2">{graphQlResult.infoboxLinksUntenTitel}</h3>
                    <CreateImage image={graphQlResult.infoboxLinksUntenBild} {...this.props} />
                  </div>
                  <div className="col-12 col-md-2 col-lg-3" />
                  <div className="col-12 col-md-12">
                    <ContentfulMarkdownText text={graphQlResult.infoboxLinksUntenBeschreibung.infoboxLinksUntenBeschreibung} />
                  </div>
                </div>
              </div>
              ...
              <div className="col-12 col-md-6">
                {graphQlResult.artenVonStudenten.length > 0 ? (
                  <div className="">
                    ...
                    <h4 className="padding-sm-bottom">{graphQlResult.artenVonStudenten[0].ueberschrift}</h4>
                    <ContentfulMarkdownText text={graphQlResult.artenVonStudenten[0].beschreibung.beschreibung} />
                  </div>
                ) : null}
              </div>
            </div>
              ...
              <div className="col-12 col-md-6 offset-md-6">
                {graphQlResult.artenVonStudenten.length > 1 ? (
                  <div className="">
                    ...
                    <h4 className="padding-sm-bottom">{graphQlResult.artenVonStudenten[1].ueberschrift}</h4>
                    <ContentfulMarkdownText text={graphQlResult.artenVonStudenten[1].beschreibung.beschreibung} />
                  </div>
                ) : null}
              </div>
            </div>
            ...
            <div className="row">
              <div className="col-12 col-md-6">
                {graphQlResult.artenVonStudenten.length > 2 ? (
                  <div className="">
                    <div className="d-block d-md-none margin-40-top" />
                    <h4 className="padding-sm-bottom">{graphQlResult.artenVonStudenten[2].ueberschrift}</h4>
                    <ContentfulMarkdownText text={graphQlResult.artenVonStudenten[2].beschreibung.beschreibung} />
                  </div>
                ) : null}
              </div>
            </div>
            ...
            <div className="row">
              <div className="col-12 col-md-6 offset-md-6">
                {graphQlResult.artenVonStudenten.length > 3 ? (
                  <div className="">
                    <div className="d-block d-md-none margin-40-top" />
                    <h4 className="padding-sm-bottom">{graphQlResult.artenVonStudenten[3].ueberschrift}</h4>
                    <ContentfulMarkdownText text={graphQlResult.artenVonStudenten[3].beschreibung.beschreibung} />
                  </div>
                ) : null}
              </div>
            </div>
            ...
            <div className="row">
              <div className="col-12 col-md-6">
                {graphQlResult.artenVonStudenten.length > 4 ? (
                  <div className="">
                    <div className="d-block d-md-none margin-40-top" />
                    <h4 className="padding-sm-bottom">{graphQlResult.artenVonStudenten[4].ueberschrift}</h4>
                    <ContentfulMarkdownText text={graphQlResult.artenVonStudenten[4].beschreibung.beschreibung} />
                  </div>
                ) : null}
              </div>
            </div>
            ...
            <div className="row">
              <div className="col-12 col-md-6 offset-md-6">
                {graphQlResult.artenVonStudenten.length > 5 ? (
                  <div className="">
                    <div className="d-block d-md-none margin-40-top" />
                    <h4 className="padding-sm-bottom">{graphQlResult.artenVonStudenten[5].ueberschrift}</h4>
                    <ContentfulMarkdownText text={graphQlResult.artenVonStudenten[5].beschreibung.beschreibung} />
                  </div>
                ) : null}
              </div>
            </div>
