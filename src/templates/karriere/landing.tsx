  ...
  render() {
    ...
    return (
      <div>
        ...
        <HeroImageLayout title={graphQlResult.hauptueberschrift} titleImage={titelBildDesktop} titleImageSmall={titelBildMobile} />
        ...
        <div className="container margin-60-top">
          <div className="row">
            <div className="col text-center">
              <LinkButton text="MEHR ÜBER COFINPRO" path="/karriere/ueber-uns" {...this.props} />
            </div>
          </div>
        </div>
              ...
              <div className="border-img-blue padding-md">
                ...
                <div className="row padding-sm-top">
                  <div className="col-12 col-md-9">
                    <LinkButton text={graphQlResult.buttonRechteBox} path="/karriere/jobs" {...this.props} />
                  </div>
                </div>
              </div>
            </div>
        ...
        <div className="container margin-120-top">
          <div className="row">
            <div className="col-12 col-md-8 mx-auto">
              ...
              <p className="p-font-large-md">{graphQlResult.socialMediaBeschreibung.socialMediaBeschreibung}</p>
            </div>
