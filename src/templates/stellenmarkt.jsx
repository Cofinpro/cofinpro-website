...
class StellenmarktTemplate extends React.Component {
    ...
    render() {
        ...
        function markPresentGroups() {
            stellenAnzeigen.map((item, i) => {
                if (item.node.perspektiveLink.name === 'andere') {
                    andereFound = true;
                } else if (item.node.perspektiveLink.name === 'fachlicher-professional' || item.node.perspektiveLink.name === 'fachlicher-absolvent') {
                    fachFound = true;
                } else if (item.node.perspektiveLink.name === 'technologischer-professional' || item.node.perspektiveLink.name === 'technologischer-absolvent') {
                    techFound = true;
        ...
        function StellenangeboteAndere(props) {
            ...
            return <div className="container padding-lg-top-bottom">
                <div className="row justify-content-start">
                    <div className="col-12 col-md-10 col-lg-8">
                        <h3>JOBANGEBOTE FÜR ANDERE EXPERTISEN</h3>
                        <div className="row">

                            {stellenAnzeigen != null && stellenAnzeigen.length > 0 ? stellenAnzeigen.map((item, i) => {

                                var stellenAnzeige = item.node;

                                if (stellenAnzeige.perspektiveLink.name === 'andere') {
                                    return (
                                        <div className="col-12 col-md-6 padding-sm-top-bottom" key={"column-ANDERE-" + i}>
                                            <CarrerOfferPreview
                        ...
                        <div className="row">
                            ...
                            {stellenAnzeigen != null && stellenAnzeigen.length > 0 ? stellenAnzeigen.map((item, i) => {
                                ...
                                if (stellenAnzeige.perspektiveLink.name === 'studenten') {
                                    return (
                                        <div className="col-12 col-md-6 padding-sm-top-bottom" key={"column-STUDI-" + i}>
                                            <CarrerOfferPreview
                    ...
                    <div className="col-12 col-md-10 col-lg-8">
                        ...
                        <div className="row">
                            ...
                            {stellenAnzeigen != null && stellenAnzeigen.length > 0 ? stellenAnzeigen.map((item, i) => {
                                ...
                                if (stellenAnzeige.perspektiveLink.name === 'fachlicher-professional' || stellenAnzeige.perspektiveLink.name === 'fachlicher-absolvent') {
                                    return (
                                        <div className="col-12 col-md-6 padding-sm-top-bottom" key={"column-FACHBERATER-" + i}>
                                            <CarrerOfferPreview
                    ...
                    <div className="col-12 col-md-10 col-lg-8">
                        ...
                        <div className="row">
                            ...
                            {stellenAnzeigen != null && stellenAnzeigen.length > 0 ? stellenAnzeigen.map((item, i) => {
                                ...
                                if (stellenAnzeige.perspektiveLink.name === 'technologischer-professional' || stellenAnzeige.perspektiveLink.name === 'technologischer-absolvent') {
                                    return (
                                        <div className="col-12 col-md-6 padding-sm-top-bottom" key={"column-TECHI-" + i}>
                                            <CarrerOfferPreview
        ...
        return (
            <div>
                ...
                <div
                    className="container bg-orange-light padding-lg-top-bottom margin-lg-top-bottom">
                    <div className="row">
                        <div className="col text-center">
                            <h2 className="h5 padding-sm-bottom">{graphQlResult.callToActionText.callToActionText}</h2>
                            <a href={graphQlResult.linkZurInitiativBewerbung.linkZurExternenQuelle.linkZurExternenQuelle}>
                                <span className="btn btn btn-outline-primary">{graphQlResult.linkZurInitiativBewerbung.linkBezeichnung}</span>
                            </a>
                        </div>
                    </div>
                </div>
