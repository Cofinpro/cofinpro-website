        ...
        return (
            <div>
                ...
                <div className="container padding-md-top-bottom margin-md-top-bottom">
                    ...
                    <CarrerOfferCarouselBox titel={graphQlResult.ueberschriftStellenanzeigen} stellenAnzeigen={stellenAnzeigen} buttonText={"MEHR JOBS ANZEIGEN"} {...this.props} />          
                ...
                <div className="container padding-md-top-bottom">
                    <div className="row padding-md-top-bottom">
                        <div className="col">
                            <h2 className="h6">{graphQlResult.bewerbungsprozessUntertitel}</h2>
                            ...
                            <div className="row">
                                ...
                                <div className="col-12 order-1">
                                    ...
                                    <div className="row d-flex align-items-center">
                                        ...
                                        <div className="col-10">
                                            <p className="h4">{graphQlResult.bewerbungsprozessSchritt1Titel}</p>
                                        </div>
                                    </div>
                                    <div className="row">
                                        <div className="col">
                                            <ContentfulImage imageFile={graphQlResult.bewerbungsprozessSchritt1Bild} styleClasses="img-fluid padding-sm-top-bottom" />
                                            <p>{graphQlResult.bewerbungsprozessSchritt1Beschreibung.bewerbungsprozessSchritt1Beschreibung}</p>
                                        </div>
                                    </div>
                                ...
                                <div className="col-12 order-3">
                                    ...
                                    <div className="row">
                                        ...
                                        <div className="col-10">
                                            <p className="h4">{graphQlResult.bewerbungsprozessSchritt3Titel}</p>
                                        </div>
                                    </div>
                                    <div className="row">
                                        <div className="col">
                                            <ContentfulImage imageFile={graphQlResult.bewerbungsprozessSchritt3Bild} styleClasses="img-fluid padding-sm-top-bottom" />
                                            <p>{graphQlResult.bewerbungsprozessSchritt3Beschreibung.bewerbungsprozessSchritt3Beschreibung}</p>
                                        </div>
                                    </div>
                            ...
                            <div className="row">
                                ...
                                <div className="col-12 order-2">
                                    ...
                                    <div className="row">
                                        ...
                                        <div className="col-10">
                                            <p className="h4">{graphQlResult.bewerbungsprozessSchritt2Titel}</p>
                                        </div>
                                    </div>
                                    <div className="row">
                                        <div className="col">
                                            <ContentfulImage imageFile={graphQlResult.bewerbungsprozessSchritt2Bild} styleClasses="img-fluid padding-sm-top-bottom" />
                                            <p>{graphQlResult.bewerbungsprozessSchritt2Beschreibung.bewerbungsprozessSchritt2Beschreibung}</p>
                                        </div>
                                    </div>
                                ...
                                <div className="col-12 order-4">
                                    ...
                                    <div className="row">
                                        ...
                                        <div className="col-10">
                                            <p className="h4">{graphQlResult.bewerbungsprozessSchritt4Titel}</p>
                                        </div>
                                    </div>
                                    <div className="row">
                                        <div className="col">
                                            <ContentfulImage imageFile={graphQlResult.bewerbungsprozessSchritt4Bild} styleClasses="img-fluid padding-sm-top-bottom" />
                                            <p>{graphQlResult.bewerbungsprozessSchritt4Beschreibung.bewerbungsprozessSchritt4Beschreibung}</p>
                                        </div>
                                    </div>
                ...
                <div className="container bg-orange-light padding-lg-top-bottom margin-lg-top-bottom">
                    <div className="row">
                        <div className="col text-center">
                            <ContentfulMarkdownText text={graphQlResult.callToActionUntenText.callToActionUntenText} styleClasses="img-fluid h5 d-block d-md-none w-100"/>
                            <ContentfulMarkdownText text={graphQlResult.callToActionUntenText.callToActionUntenText} styleClasses="h5 d-none d-md-block w-75 mx-auto"/>
                            <div className="row">
                                <div className="col-12 col-md-6 padding-md-top text-md-right">
                                    <Link to={pathPrefix + "/jobs"}>
                                        <span className="btn btn-outline-primary space-button-left-right">AUF FREIEN JOB BEWERBEN</span>
                                    </Link>
                                </div>
                                <div className="col-12 col-md-6 padding-md-top text-md-left">
                                    <a href={graphQlResult.linkZurInitiativBewerbung.linkZurExternenQuelle.linkZurExternenQuelle} target="_blank">
                                        <span className="btn btn-outline-primary space-button-left-right">{graphQlResult.linkZurInitiativBewerbung.linkBezeichnung}</span>
                                    </a>
                                </div>
                            </div>
                        </div>
