                ...
                <div className="container padding-md-top-bottom">
                    ...
                    <div className="row justify-content-center">
                        <div className="col-12 col-md-8 text-center">
                            ...
                            <ContentfulImage imageFile={news.newsBild} styleClasses="img-fluid padding-sm-top-bottom"/>
                            <p className="margin-md-bottom">{news.absatz2 != null ? news.absatz2.absatz2 : ""}</p>
                            <Link to={pathPrefix + "/pinnwand"}>
                                <span className="btn btn btn-outline-primary">ZUR PINNWAND</span>
                            </Link>
                        </div>
                    </div>
                </div>
