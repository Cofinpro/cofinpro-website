                    ...
                    meta={[
                        {
                            ...
                            property: 'og:type', content: 'de_DE' 
                        }
                    ]} />
                ...
                <div className="container margin-lg-top-bottom">
                                ...
                                <div className="">
                                    <div className="row">
                                        <div className="col-12">
                                            ...
                                            <p className="h2 text-white padding-sm-top d-none d-md-block">KOMPETENZEN</p>

                                            <h2 className="h4 subtitle-welcome padding-sm-top d-block d-md-none">
                                                {graphQlResult.untertitelDerSeite.untertitelDerSeite}
                                            </h2>
                                            <p className="h4 text-white padding-sm-top d-block d-md-none">KOMPETENZEN</p>
                                        </div>
                                    </div>

                                    <div className="row text-center">
                                        <div className="col-12 col-md-3 d-none d-md-block">
                                            <ContentfulImage imageFile={graphQlResult.bildFuerPerspektiveFach} styleClasses="img-fluid img-consultant padding-sm-top-bottom" />
                                            <h3 className="h6 link-black">FACHBERATER</h3>
                                        </div>
                                        <div className="col-12 col-md-3 d-none d-md-block">
                                            <ContentfulImage imageFile={graphQlResult.bildFuerPerspektiveTech} styleClasses="img-fluid img-consultant padding-sm-top-bottom" />
                                            <h3 className="h6 link-black">TECHNOLOGISCHER BERATER</h3>
                                        </div>
                                        <div className="col-12 col-md-3 d-none d-md-block">
                                            <ContentfulImage imageFile={graphQlResult.bildFuerPerspektiveStudent} styleClasses="img-fluid img-consultant padding-sm-top-bottom" />
                                            <Link
                                                className="text-dark"
                                                to={pathPrefix + "/studenten/landing"}
                                                onClick={() => { StorageHelper.saveInSessionStorage('perspective', 'studenten') }}>
                                                <h3 className="h6 link-black">> STUDENT</h3>
                                            </Link>
                                        </div>
                                        <div className="col-12 col-md-3 d-none d-md-block">
                                            <ContentfulImage imageFile={graphQlResult.bildFuerPerspektiveAndere} styleClasses="img-fluid img-consultant padding-sm-top-bottom" />
                                            <Link
                                                className="text-dark"
                                                to={pathPrefix + "/andere/landing"}
                                                onClick={() => { StorageHelper.saveInSessionStorage('perspective', 'andere') }}>
                                    ...
                                    <div className="row text-center">
                                        <div className="col-12 col-md-3 d-none d-md-block">
                                            <Link
                                                ...
                                                onClick={() => { StorageHelper.saveInSessionStorage('perspective', 'fachlicher-absolvent') }}>
                                                <h3 className="h6 link-black">> Absolvent & Young Professional</h3>
                                            </Link>
                                            <Link
                                                className="text-dark"
                                                to={pathPrefix + "/fachlicher-professional/landing"}
                                                onClick={() => { StorageHelper.saveInSessionStorage('perspective', 'fachlicher-professional') }}>
                                        ...
                                        <div className="col-12 col-md-3 d-none d-md-block">
                                            <Link
                                                ...
                                                onClick={() => { StorageHelper.saveInSessionStorage('perspective', 'technologischer-absolvent') }}>
                                                <h3 className="h6 link-black">> Absolvent & Young Professional</h3>
                                            </Link>
                                            <Link
                                                className="text-dark"
                                                to={pathPrefix + "/technologischer-professional/landing"}
                                                onClick={() => { StorageHelper.saveInSessionStorage('perspective', 'technologischer-professional') }}>
                                                <h3 className="h6 link-black">> Professional</h3>
                                            </Link>
                                        </div>
                                        <div className="col-12 col-md-3 d-none d-md-block">
                                        ...
                                        <div className="col-12">
                                            ...
                                            <p>
                                                <Link
                                                    to={pathPrefix + "/fachlicher-absolvent/landing"}
                                                    onClick={() => { StorageHelper.saveInSessionStorage('perspective', 'fachlicher-absolvent') }}>
                                                    <span className="h5">> Absolvent & Young Professional</span>
                                                </Link>
                                            </p>
                                            <p>
                                                <Link
                    ...
                    <div className="row padding-lg-top-bottom">
                        <div className="col-12">
                            ...
                            <button id="button-startseite-collapse" className="btn btn-light text-white" type="button" data-toggle="collapse" data-target="#navbarToggleExternalContent" aria-controls="navbarToggleExternalContent" aria-expanded="false" aria-label="Toggle navigation">
