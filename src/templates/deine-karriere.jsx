                ...
                <div className="container padding-lg-top-bottom">
                    <div className="row">
                        ...
                        <div className="col-12 col-md-5">
                            ...
                            {graphQlResult.skills.length > 0 ? graphQlResult.skills.map((skill, i) => {
                                return (
                                    <p key={'skill-' + i} hidden={skill.ueberschrift == null ? true : false}>
                                        <span className="text-primary">{skill.ueberschrift}&nbsp;</span>
                ...
                <div className="container padding-md-top-bottom">
                    <div className="row">
                        <div className="col">
                            ...
                            <ContentfulImage imageFile={graphQlResult.bildKompetenzen} styleClasses="img-fluid d-none d-md-block" />
                            <ContentfulImage imageFile={graphQlResult.bildKompetenzenSmartphone} styleClasses="img-fluid d-block d-md-none" />
                        </div>
                    </div>
                </div>
